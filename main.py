#Yahia Nassar 223200107
#Henrik Radtke 223201707
#Marc Emmerz 223201029
#Ole Kubisch 222200522
#Julian Kleeman 223200291
import typing
import random
...
def compute_voronoi(board, you_head, enemy_head):
    # Flächenkontrolle berechnen - Yahia
...
class VoronoiAgent:
    ...
    def choose_move(self):
        # Besten Zug wählen - Henrik
        self.voronoi_you, self.voronoi_enemy, _ = compute_voronoi(
            self.board, self.my_head, self.enemy['body'][0]
        )
        mode = "neutral"
...
def is_tail_reachable(start, tail, board, snakes):
    # Prüft Tail-Erreichbarkeit - Marc
    visited = set()
    queue = deque()
